# -*- coding: utf-8 -*-
"""
Created on Mon May 15 09:42:00 2023
...
file= input_data_fp + "/SKR_LFEs.json"
lfe_df=make_dataframe(file)

lfe_df.to_csv(output_data_fp + "/lfe_timestamps.csv",index=False)
...
nolfe_df.to_csv(output_data_fp + "/nolfe_timestamps.csv",index=False)
...
total_df.to_csv(output_data_fp + "/total_timestamps.csv",index=False)
